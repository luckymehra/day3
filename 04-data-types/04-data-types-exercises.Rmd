...
Use the `hour` and `minute` variables in `flights` to make a new variable name `time` that shows the time of each flight as an hms. Hint: you can use the `mutate()` to create a new variable.
